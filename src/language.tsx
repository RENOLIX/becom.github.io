...
const arTranslations: Record<string, string> = {
  ...
  "Le design volontairement simple encourage l'enfant à inventer ses propres règles. Sans écran, sans scénario imposé, avec juste ce qu'il faut pour nourrir sa curiosité.": "يشجع التصميم البسيط والمدروس الطفل على ابتكار قواعده الخاصة. بلا شاشة ولا سيناريو مفروض، فقط ما يكفي لتنمية فضوله وإطلاق خياله.",
  "Choisir la couleur": "اختر اللون",
  "Choisir une option": "اختر خيارا",
  "pièces": "قطعة",
  "JEUX": "ألعاب",
  "BLEU": "أزرق",
  "JAUNE": "أصفر",
